  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[820px] h-[820px] rounded-full bg-emerald-500/8 blur-[140px]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center max-w-2xl mx-auto reveal">
          ...
          <p className="mt-5 text-white/55 font-light">
        ...
        <div className="mt-16 max-w-4xl mx-auto reveal">
          <div className="glass-card rounded-3xl p-1">
            <div className="rounded-[22px] bg-gradient-to-b from-white/[0.04] to-transparent border border-white/[0.06] p-8 md:p-12 grid md:grid-cols-2 gap-10 items-center">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-[11px] uppercase tracking-[0.2em]">
                  Limited launch batch
                </div>
                <h3 className="font-display text-3xl md:text-4xl font-medium mt-5">
                  Lockin <span className="text-white/40">Classic</span>
                </h3>

                <div className="mt-6 flex items-baseline gap-3">
                  <div className="font-display text-5xl md:text-6xl tracking-tighter">
                    $89
                  </div>
                  <div className="text-white/40 line-through text-lg">$119</div>
                  <span className="ml-2 text-xs uppercase tracking-[0.2em] text-emerald-400">
                    Save 25%
                  </span>
                </div>
                ...
                <Dialog open={open} onOpenChange={(o) => { setOpen(o); if (!o) setDone(false); }}>
                  <DialogTrigger asChild>
                    <Button
                      ...
                      className="mt-10 h-12 px-7 rounded-full bg-white text-black hover:bg-white/90 text-sm font-medium"
                    >
                  ...
                  >
                    {!done ? (
                        ...
                        <div className="space-y-4 py-4">
                          <div>
                            ...
                            <Input
                              ...
                              className="mt-1 bg-white/5 border-white/10 text-white placeholder:text-white/30 focus-visible:ring-emerald-500/40"
                            />
                          </div>
                          <div>
                            <Label
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              className="mt-1 bg-white/5 border-white/10 text-white focus-visible:ring-emerald-500/40"
                            />
                          </div>
                        </div>
                        <DialogFooter>
                          <Button
                            ...
                            className="w-full h-11 rounded-full bg-white text-black hover:bg-white/90"
                          >
                            {loading ? (
                      ...
                      <div className="py-6 text-center" data-testid="order-success">
                        ...
                        <h3 className="font-display text-2xl font-medium mt-5">
                          You're locked in.
                        </h3>
              ...
              <div className="relative">
                <div className="aspect-square rounded-3xl bg-gradient-to-br from-emerald-500/10 via-white/[0.02] to-transparent border border-white/10 overflow-hidden relative">
                  <img
